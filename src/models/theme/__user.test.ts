...
import { UserCategory } from './theme.types'
...
describe('user schema test', () => {
  ...
  it('create new user', () => {
    ...
    return ThemeModel.create(product)
      .then((user) => {
  ...
  it('get tested user', () => {
    return ThemeModel.findOne({ email: 'abc@gmail.com' })
      .then((data) => {
        userId = data._id
  ...
  it('update tested user', () => {
    ...
    return ThemeModel.findByIdAndUpdate(userId, { $set: toUpdateData }, { returnDocument: 'after', returnOriginal: false })
      .then((data) => {
  ...
  it('delete tested user', () => {
    return ThemeModel.deleteOne({ email: 'abc@gmail.com' })
      .then((data) => {
