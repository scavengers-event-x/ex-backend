...
import { UserCategory } from './decoration.types'
...
describe('user schema test', () => {
  ...
  it('create new user', () => {
    ...
    return DecorationModel.create(product)
      .then((user) => {
  ...
  it('get tested user', () => {
    return DecorationModel.findOne({ email: 'abc@gmail.com' })
      .then((data) => {
        userId = data._id
  ...
  it('update tested user', () => {
    ...
    return DecorationModel.findByIdAndUpdate(userId, { $set: toUpdateData }, { returnDocument: 'after', returnOriginal: false })
      .then((data) => {
  ...
  it('delete tested user', () => {
    return DecorationModel.deleteOne({ email: 'abc@gmail.com' })
      .then((data) => {
